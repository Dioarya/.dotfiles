...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Search through only git files (files not ignored by .gitignore)
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        if bufname:match '/node_modules/' or bufname:match '\\node_modules/' or bufname:match '/node_modules\\' or bufname:match '\\node_modules\\' then
          return
        end
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'powershell', 'ebnf' },
  ...
  -- { 'nicholasmata/nvim-dap-cs', dependencies = { 'mfussenegger/nvim-dap' }, branch = 'saul-marquez-feat/win-compatibility' },
  ...
  --
  --  Uncomment the following line and add your plugins to `lua/custom/plugins/*.lua` to get going.init.lua
